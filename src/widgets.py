...
class OrderWidget(QFrame):
    ...
    def init_ui(self):
        ...
        deadline_layout.setContentsMargins(15, 0, 0, 0)
        ...
        payments_box_layout.setContentsMargins(10, 8, 10, 8)
        ...
        history_payment_btn.setFixedWidth(120)
        ...
        payments_box_layout.addWidget(self.payment_status)
        ...
        files_label = QLabel(f"📎 Элементы ({files_count}):")
        ...
        if not self.order.files:
            drag_label = QLabel("📁 перетащите сюда файлы или папки")
            drag_label.setStyleSheet("color: #DDDDDD; font-size: 12px; font-style: italic; padding: 15px; background-color: #252525; border-radius: 4px; border: 1px dashed #555555;")
            drag_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
            self.files_layout.addWidget(drag_label)
        ...
        self.files_layout.addLayout(btns)
