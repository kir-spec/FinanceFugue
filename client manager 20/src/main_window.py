...
from PySide6.QtGui import QPalette, QColor, QAction, QKeySequence, QShortcut, QDesktopServices, QIcon
from PySide6.QtCore import Qt, QPropertyAnimation, QEasingCurve, QParallelAnimationGroup, QSize, QPoint, QAbstractAnimation, QUrl
...
class FinanceFugue(QMainWindow):
    ...
    def init_ui(self):
        self.setWindowTitle("FinanceFugue")
        self.resize(900, 800)
