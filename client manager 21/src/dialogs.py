...
from PySide6.QtCore import Qt, QPropertyAnimation, QEasingCurve, QParallelAnimationGroup, QSequentialAnimationGroup, QPoint
...
def animate_dialog_open(dialog):
    ...
    if dialog.parent:
        ...
        center_x = parent_geo.x() + (parent_geo.width() - dialog.width()) // 2
        center_y = parent_geo.y() + (parent_geo.height() - dialog.height()) // 2
        
        # Устанавливаем диалог ровно по центру
