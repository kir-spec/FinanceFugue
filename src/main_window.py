...
class ProMusicCRM(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.sort_combo.addItems(["Имя (А-Я)", "Имя (Я-А)", "Новые заказы", "Старые заказы", "Срочные"])
    ...
    def render_client_profile(self):
        ...
        if client.orders:
            ...
            no_orders.setStyleSheet("color: #DDDDDD; font-style: italic; padding: 20px; background-color: #252525; border-radius: 8px;")
